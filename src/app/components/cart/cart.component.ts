...
export class CartComponent implements OnInit {
  ...
  constructor(private toastService: HotToastService ,public cartService: CartService, public stateService: StateService,
  ...
  public onDeleteClick(productId: number) {
    ...
    this.stateService.totalProductInCart ()
    this.toastService.error('Product removed from cart')
  }
